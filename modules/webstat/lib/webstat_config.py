...
if CFG_CERN_SITE:
    CFG_ELASTICSEARCH_EVENTS_MAP = {
        ...
        "events.ebidding_opening": True,
        "events.ejournal": True,
        "events.journals": True,
        "events.loanrequest": True,
        "events.media_download": True,
        "events.media_view": True,
        "events.pageviews": True,
        "events.websubmissions": True,
    }
else:
    CFG_ELASTICSEARCH_EVENTS_MAP = {}
